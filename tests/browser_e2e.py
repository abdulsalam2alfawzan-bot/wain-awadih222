...
def wait_result(page) -> dict:
    ...
    expect(page.locator("#partnerResult")).to_contain_text("بيانات Seed تجريبية")
...
try:
    with sync_playwright() as pw:
        ...
        page.locator("#ratingComment").fill("تجربة تجريبية جيدة")
        ...
        page.locator("#partnerCode").fill("WA-DEMO")
