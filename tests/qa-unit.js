...
assert(partners.every((row) => row.isDemo && row.demoNotice && row.region && row.googleMapsUrl), 'Seed marking/details failed');
...
log('Seed آمن وغير هدّام وموسوم كتجريبي مع وثائق وتغطية');
...
const serviceProbes = [
  ...
  { serviceType: 'tow', region: 'منطقة القصيم', city: 'بريدة', preciseLocation: '26.35,43.96', placeDescription: 'بجوار محطة تجريبية', vehicleMoves: 'لا تتحرك', vehicleSnapshot: basePayload.vehicle },
...
log('سداد تجريبي وإيصال وربط الفاتورة بالمدفوعات');
